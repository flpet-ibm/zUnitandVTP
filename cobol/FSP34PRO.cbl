      ...
      * SEGMENT SEARCH ARGUMENT
       ...
       01  OUTPUT-AREA.
           ...
           02  OUT-SEGMENT-NO  PICTURE X(4).
       01  IOAREA.
           02  IO-LINE PICTURE X(37).
           ...
           02  IO-FILLER       PIC X(3).
           02  IO-COMMAND      PIC X(8).
       01  SPA.
       ...
       PROCEDURE DIVISION USING  INPUT-MSG, OUTPUT-AREA,
            IOAREA, SPA, SPA-CALL-NO, DC-TEXT, IOPCB, DBPCB.
      ...
      *
           ...
           IF IO-COMMAND EQUAL SPACES THEN
                MOVE MINV TO OUT-MESSAGE
           ELSE IF IO-LAST-NAME EQUAL SPACES AND
                   TEMP-IOCMD NOT = 'END'
                THEN
                   MOVE MNONAME TO OUT-MESSAGE
