       ...
       PROGRAM-ID. CPRDCHE4.
      *    T
      *    All variable names, paragrahgh names cvhanged to
      *    non descriptive to see how WCA4Z Explain copes with it
      *
      *
      ...
      *
       ...
       CHECK-month    SECTION.
           ...
           IF Ws-MONTH   = 0 OR Ws-MONTH   > 12 THEN
              MOVE '2' TO RC
           END-IF.
