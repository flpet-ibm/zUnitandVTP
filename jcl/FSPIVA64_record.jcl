...
//*         DD DSN=FELE20.SBZURESL,DISP=SHR
//         DD DSN=FELE20.SBZULOAD,DISP=SHR
//         DD DSN=FELE20.SBZULLEP,DISP=SHR
...
//SYSPRINT DD SYSOUT=*
//IMSERR   DD SYSOUT=*
//DFSIVD5I DD * DISP=SHR,DSN=IBMUSER.IMS.DFSIVD5I
DIS     PETERSEN
DIS     PETERSEN2
//* ADD     HANSEN    JENS      x12345    2605
//DFSIVD5O DD SYSOUT=*
//*DFSIVD5O DD DISP=(NEW,CATLG),SHR,DSN=IBMUSER.IMS.DFSIVD5I,
//*        DCB=(LRECL=121,RECFM=FA)

//BZUPLAY  DD DISP=OLD,DSN=IBMUSER.DEFAULT.IMS.PLAYBACK
//
