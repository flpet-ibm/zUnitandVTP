      ...
      *| DATE GENERATED: 04/11/2025 11:49                              |
      *| ID: c116029f-c847-456c-9799-649aeb0a76ea                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      ...
      *+---------------------------------------------------------------+
       ...
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       ...
       01 AZ-SUB-PROGRAM    PIC X(8)  VALUE 'CPRCHECD'.
      ...
      * GET SUB PROGRAM ARGUMENT
           DISPLAY 'AZU0000I CALL BZUGTARG FOR CPRCHECD'
           ...
           IF AZ-SUB-ARG-LIST = NULL
             ...
             STRING 'SUB PROGRAM CPRCHECD NOT FOUND.'
               DELIMITED BY SIZE
      ...
      * CALL TEST PROGRAM
           DISPLAY 'AZU0000I CALL CPRCHECD'
      ...
      *+---------------------------------------------------------------+
      *| UNIT TEST FOR Z/OS: TEST_TEST8                                |
      *|     FOR TEST TEST8                                            |
      *| TEST CASE VERSION: 202                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_TEST8'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       01 AZ-CSECT       PIC X(72) VALUE SPACES.
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION USING AZ-TEST AZ-ARG-LIST AZ-INFO-BLOCK.
      * START
           DISPLAY 'AZU0000I TEST_TEST8 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 4 TO RETURN-CODE
      * END
           DISPLAY 'AZU0000I TEST_TEST8 END.'
           GOBACK.
       INITIALIZE-PARM.
           INITIALIZE ZUT00000032
           INITIALIZE ZUT00000033
      ...
      -    '*************************************'
           CALL BZUASSRT USING BZ-P1 BZ-P2 BZ-P3 BZ-ASSERT
           EXIT.
       END PROGRAM TEST_TEST8.
      *+---------------------------------------------------------------+
      *| UNIT TEST FOR Z/OS: TEST_TEST9                                |
      *|     FOR TEST TEST9                                            |
      *| TEST CASE VERSION: 202                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_TEST9'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       01 AZ-CSECT       PIC X(72) VALUE SPACES.
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION USING AZ-TEST AZ-ARG-LIST AZ-INFO-BLOCK.
      * START
           DISPLAY 'AZU0000I TEST_TEST9 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 4 TO RETURN-CODE
      * END
           DISPLAY 'AZU0000I TEST_TEST9 END.'
           GOBACK.
       INITIALIZE-PARM.
           INITIALIZE ZUT00000032
           INITIALIZE ZUT00000033
      ...
      -    '*************************************'
           CALL BZUASSRT USING BZ-P1 BZ-P2 BZ-P3 BZ-ASSERT
           EXIT.
       END PROGRAM TEST_TEST9.
      *+---------------------------------------------------------------+
      *| UNIT TEST FOR Z/OS: TEST_TEST10                               |
      *|     FOR TEST TEST10                                           |
      *| TEST CASE VERSION: 202                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_TEST10'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       01 AZ-CSECT       PIC X(72) VALUE SPACES.
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION USING AZ-TEST AZ-ARG-LIST AZ-INFO-BLOCK.
      * START
           DISPLAY 'AZU0000I TEST_TEST10 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 4 TO RETURN-CODE
      * END
           DISPLAY 'AZU0000I TEST_TEST10 END.'
           GOBACK.
       INITIALIZE-PARM.
           INITIALIZE ZUT00000032
           INITIALIZE ZUT00000033
      ...
      -    '*************************************'
           CALL BZUASSRT USING BZ-P1 BZ-P2 BZ-P3 BZ-ASSERT
           EXIT.
       END PROGRAM TEST_TEST10.
      *+---------------------------------------------------------------+
      *| UNIT TEST FOR Z/OS: TEST_TEST11                               |
      *|     FOR TEST TEST11                                           |
      *| TEST CASE VERSION: 202                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_TEST11'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       01 AZ-CSECT       PIC X(72) VALUE SPACES.
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION USING AZ-TEST AZ-ARG-LIST AZ-INFO-BLOCK.
      * START
           DISPLAY 'AZU0000I TEST_TEST11 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 4 TO RETURN-CODE
      * END
           DISPLAY 'AZU0000I TEST_TEST11 END.'
           GOBACK.
       INITIALIZE-PARM.
           INITIALIZE ZUT00000032
           INITIALIZE ZUT00000033
      ...
      -    '*************************************'
           CALL BZUASSRT USING BZ-P1 BZ-P2 BZ-P3 BZ-ASSERT
           EXIT.
       END PROGRAM TEST_TEST11.
      *+---------------------------------------------------------------+
      *| UNIT TEST FOR Z/OS: TEST_TEST12                               |
      *|     FOR TEST TEST12                                           |
      *| TEST CASE VERSION: 202                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_TEST12'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       01 AZ-CSECT       PIC X(72) VALUE SPACES.
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION USING AZ-TEST AZ-ARG-LIST AZ-INFO-BLOCK.
      * START
           DISPLAY 'AZU0000I TEST_TEST12 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 4 TO RETURN-CODE
      * END
           DISPLAY 'AZU0000I TEST_TEST12 END.'
           GOBACK.
       INITIALIZE-PARM.
           INITIALIZE ZUT00000032
           INITIALIZE ZUT00000033
      ...
      -    '*************************************'
           CALL BZUASSRT USING BZ-P1 BZ-P2 BZ-P3 BZ-ASSERT
           EXIT.
       END PROGRAM TEST_TEST12.
      *+---------------------------------------------------------------+
      *| UNIT TEST FOR Z/OS: TEST_TEST13                               |
      *|     FOR TEST TEST13                                           |
      *| TEST CASE VERSION: 202                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_TEST13'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       01 AZ-CSECT       PIC X(72) VALUE SPACES.
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION USING AZ-TEST AZ-ARG-LIST AZ-INFO-BLOCK.
      * START
           DISPLAY 'AZU0000I TEST_TEST13 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 4 TO RETURN-CODE
      * END
           DISPLAY 'AZU0000I TEST_TEST13 END.'
           GOBACK.
       INITIALIZE-PARM.
           INITIALIZE ZUT00000032
           INITIALIZE ZUT00000033
      ...
      -    '*************************************'
           CALL BZUASSRT USING BZ-P1 BZ-P2 BZ-P3 BZ-ASSERT
           EXIT.
       END PROGRAM TEST_TEST13.
      *+---------------------------------------------------------------+
      *| UNIT TEST FOR Z/OS: TEST_TEST14                               |
      *|     FOR TEST TEST14                                           |
      *| TEST CASE VERSION: 202                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_TEST14'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CPRCHECD'.
       01 AZ-CSECT       PIC X(72) VALUE SPACES.
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION USING AZ-TEST AZ-ARG-LIST AZ-INFO-BLOCK.
      * START
           DISPLAY 'AZU0000I TEST_TEST14 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 4 TO RETURN-CODE
      * END
           DISPLAY 'AZU0000I TEST_TEST14 END.'
           GOBACK.
       INITIALIZE-PARM.
           INITIALIZE ZUT00000032
           INITIALIZE ZUT00000033
      ...
      *  *** RC : ZUT00000035
       ...
       PROCEDURE DIVISION.
      * SET INPUT VALUE
           ENTRY "PGM_INPT_CPRCHECD" USING AZ-TEST AZ-INFO-BLOCK
           ZUT00000032 ZUT00000033 ZUT00000034 ZUT00000035.
           DISPLAY 'AZU0000I PGM_INPT_CPRCHECD INPUT VALUES...'.
           MOVE 0 TO RETURN-CODE.
           MOVE 0 TO AZ-TEST-NAME-LEN.
           ...
           GOBACK.
      * EVALUATE OUTPUT VALUE
           ENTRY "PGM_OUTP_CPRCHECD" USING AZ-TEST AZ-INFO-BLOCK
           ZUT00000032 ZUT00000033 ZUT00000034 ZUT00000035.
           DISPLAY 'AZU0000I PGM_OUTP_CPRCHECD CHECK VALUES...'.
           MOVE 4 TO RETURN-CODE.
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR CHARACTERS
             BEFORE INITIAL SPACE.
           ...
           WHEN 'TEST7'
             ...
             MOVE 4 TO RETURN-CODE
           WHEN 'TEST8'
             PERFORM CHECK-REC-TEST8
             MOVE 4 TO RETURN-CODE
           WHEN 'TEST9'
             PERFORM CHECK-REC-TEST9
             MOVE 4 TO RETURN-CODE
           WHEN 'TEST10'
             PERFORM CHECK-REC-TEST10
             MOVE 4 TO RETURN-CODE
           WHEN 'TEST11'
             PERFORM CHECK-REC-TEST11
             MOVE 4 TO RETURN-CODE
           WHEN 'TEST12'
             PERFORM CHECK-REC-TEST12
             MOVE 4 TO RETURN-CODE
           WHEN 'TEST13'
             PERFORM CHECK-REC-TEST13
             MOVE 4 TO RETURN-CODE
           WHEN 'TEST14'
             PERFORM CHECK-REC-TEST14
             MOVE 4 TO RETURN-CODE
           WHEN OTHER
             CONTINUE
           END-EVALUATE.
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE 'c116029f-c847-456c-9799-649aeb0a76ea'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      *  *** WS-TODAY : ZUT00000029
       1 ZUT00000029.
      *    *** WS-TODAY-YEAR : ZUT0000002A
         5 ZUT0000002A PIC 9999.
      *    *** WS-TODAY-MONTH : ZUT0000002B
         5 ZUT0000002B PIC 99.
      *    *** WS-TODAY-DAY : ZUT0000002C
      ...
      * ENTRY FOR CHECK OUTPUT VALUE WITH CSECT
           ENTRY "PGM_INPT_CPRCHECD_CPRTODAD" USING
              AZ-TEST AZ-INFO-BLOCK
           ZUT00000029.
           DISPLAY
           'AZU0000I PGM_INPT_CPRCHECD_CPRTODAD CHECK VALUES...' .
           PERFORM PROC_INPT.
           GOBACK.
       ENTRY_OUTP.
      ...
      * ENTRY FOR SET INPUT VALUE WITH CSECT
           ENTRY "PGM_OUTP_CPRCHECD_CPRTODAD" USING
              AZ-TEST AZ-INFO-BLOCK
           ZUT00000029.
           DISPLAY
           'AZU0000I PGM_OUTP_CPRCHECD_CPRTODAD INPUT VALUES...' .
           PERFORM PROC_OUTP.
           GOBACK.
       PROC_INPT.
      * CHECK OUTPUT VALUE
      ...
      * SET AREA ADDRESS TO POINTER
           ...
           WHEN 'TEST8'
             PERFORM P-OUTPUT-TEST8
           WHEN 'TEST9'
             PERFORM P-OUTPUT-TEST9
           WHEN 'TEST10'
             PERFORM P-OUTPUT-TEST10
           WHEN 'TEST11'
             PERFORM P-OUTPUT-TEST11
           WHEN 'TEST12'
             PERFORM P-OUTPUT-TEST12
           WHEN 'TEST13'
             PERFORM P-OUTPUT-TEST13
           WHEN 'TEST14'
             PERFORM P-OUTPUT-TEST14
           WHEN OTHER
             CONTINUE
           END-EVALUATE.
           PERFORM TEARDOWN.
      ...
      * SET AREA ADDRESS TO POINTER
           ...
           WHEN 'TEST8'
             PERFORM P-INPUT-TEST8
           WHEN 'TEST9'
             PERFORM P-INPUT-TEST9
           WHEN 'TEST10'
             PERFORM P-INPUT-TEST10
           WHEN 'TEST11'
             PERFORM P-INPUT-TEST11
           WHEN 'TEST12'
             PERFORM P-INPUT-TEST12
           WHEN 'TEST13'
             PERFORM P-INPUT-TEST13
           WHEN 'TEST14'
             PERFORM P-INPUT-TEST14
           WHEN OTHER
             CONTINUE
           END-EVALUATE.
           PERFORM TEARDOWN.
